...
const JadwalTable = (
  ...
  return (
    <Table headers={['Kelas', 'Hari', 'Jam Ke', 'Mapel', 'Pengajar', 'Created At', 'Updated At', 'Actions']}>
      {jadwals.map((j) => (
        <tr key={j._id}>
          ...
          <td className="px-6 py-4 whitespace-nowrap text-sm">
            <Link to={`/jadwal/guru/${j._id}`} className="text-blue-500 hover:text-blue-700 mr-3">
              Detail
            </Link>
            {/* <Link 
              to="#"
